...
public class StringUtil {
    final String REGEX_TO_GET_CHARS_BETWEEN_PARENTHESES = "[\\(\\)]";
    final String REGEX_TO_GET_EMAIL_FROM_HREF_TAG       = "[\\t\\n\\r]";
    final String REGEX_FOR_BOTH_HYPHENS                 = "[-–]";
    final String REGEX_FOR_SPACES                       = "[ ]";
